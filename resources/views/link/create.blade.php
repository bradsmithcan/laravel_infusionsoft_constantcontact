...
@section('content')
    ...
    <div id="mainModal" class="modal" tabindex="-1" data-keyboard="false" data-backdrop="static">
        <div class="modal-dialog">
                            ...
                            <div class="row">
                                @if (count($errors) > 0)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!!  	Form::select('user_id', $users, old('user_id') , ['onchange' => 'addprofile();', 'class' => 'form-control', 'id'=> 'mypro'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                            {!!  	Form::select('domain_id', $domains, old('domain_id') , [ 'class' => 'form-control', 'id'=> 'domains'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <a href="http://usergrow.com/feed.rss" target="_blank">Example Input RSS
                                                feed</a>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            {!! Form::url('page_url',null,['id'=>'page_url', 'class'=>'form-control', 'placeholder'=>'http://pageurl.com']) !!}
                                    ...
                                    <div id="custom_short_link" class="form-group" style="display: none;">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::url('short_url',null,['id'=>'short_url', 'class'=>'form-control', 'placeholder'=>'xxx'] ) !!}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::radio('optionsRadios', 'button', true ,['id'=>'optionsRadios', 'class'=>'action_type_opt']) !!} {!! Form::label('optionsRadios', 'Button') !!}
                                            {!! Form::radio('optionsRadios', 'form', false, ['id'=>'optionsRadios-form', 'class'=>'action_type_opt']) !!} {!! Form::label('optionsRadios', 'Form Opt-in') !!}
                                        </div>
                                    </div>

                                    <div id="email_services" class="form-group" style="display: none;">
                                        <div class="col-xs-12">
                                            {!! Form::label('email_service_id', 'Email Services:') !!}
                                        </div>
                                        <div class="col-xs-12">
                                            {!! Form::select('email_service_id', $email_services, old('email_service_id') , [ 'class' => 'form-control', 'id'=> 'email_service_id'])!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('inputMessage', '', ['id'=>'inputMessage', 'placeholder' => 'Enter Your Message', 'class' => 'form-control', 'required'=>'true']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::textarea('snip_remarketing_code', '', ['id' => 'snip_remarketing_code', 'placeholder' => 'Enter Your Retargeting Code Here', 'rows' => '5','class' => 'form-control']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('button_text', '', ['id'=>'button_text', 'placeholder' => 'Button Text', 'class' => 'form-control', 'onblur'=>'buttontext();']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::url('button_url', '', ['id'=>'button_url', 'placeholder' => 'http://usergrow.com', 'class' => 'form-control']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('background_color', '', ['id'=>'bggcolor', 'class' => 'pick-a-color form-control']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('text_color', '', ['id'=>'text_color', 'class' => 'pick-a-color1 form-control']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('action_color', '', ['id'=>'action_color', 'class' => 'pick-a-color2 form-control']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!! Form::text('action_text_color', '', ['id'=>'action_text_color', 'class' => 'pick-a-color3 form-control']) !!}
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!!  Form::select('theme', $themes, old('theme') , ['id' => 'theme_type', 'class' => 'form-control', 'onchange'=>'changetheme()'])!!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group hidden" id="full_wid_img">
                                        <div class="col-xs-12"><label class="control-label"
                                                                      for="upload_path">Image</label></div>
            ...
            <span id="error_upload_msg" class="alert alert-danger hidden" style="float:left;">
                Please upload Image
                                            ...
                                            <input class="form-control" type="hidden" name="upload_path"
                                                   id="upload_path_id" value="1"/>
                                            <input class="form-control" type="hidden" name="candy_upload_path"
                                                   id="candy_upload_path_id" value="1"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-12">
                                            {!!  Form::select('position', $position, old('position') , ['id' => 'post_text', 'class' => 'form-control'])!!}
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <div class="col-xs-3">
                                        ...
                                        <div class="col-xs-4 col-lg-offset-5">
                                            ...
                                            {!! Form::submit('Create', ['id'=>'mysnips', 'class' => 'btn btn-default form-control']) !!}
                                        </div>
                                    </div>
                                    {!! Form::close() !!}
                            </div>
        ...
        <link href="{!! URL::asset('') !!}fileupload/uploadfile.css" rel="stylesheet">
        <script src="{!! URL::asset('') !!}fileupload/jquery.uploadfile.js"></script>
        <style type="text/css">
            .pick-a-color {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                $.ajax({
                    ...
                    data: {_token: $('#is_token').val(), action: "profile", id: $("#mypro :selected").val()},
                    success: function (data) {
...
//      showStatusAfterSuccess: false,
                    ...
                    onSuccess: function (files, data, xhr) {
                        if ($('#is_candy').val() == 1) {
                            ...
                            $('#candy_profile_left_img').html("<img style='width:160px;' id='theImg' src='" + data + "'/>");
                        } else {
            ...
            jQuery(document).on('onkeypress', "#short_url", function (e) {
                $.ajax({
                    ...
                    data: {_token: $('#is_token').val(), short_link: $(this).val()},
                    success: function (data) {
                        var data = jQuery.parseJSON(data);
