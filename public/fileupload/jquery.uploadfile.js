...
//    $.getScript("/css/fileupload/jquery.form.js");
  }
  var feature = {};
...
//            img = '<img src="' + this.result + '" width="50" height="50" />';
////            pd.imageDiv.html(img);
//          }
          reader.onloadend = function(evt) { // set image data as background of div
            img = '<img src="' + evt.target.result + '" width="50" height="50" />';
//            pd.imageDiv.html(img);
            if(reader.readyState==2) { // set image data as background of div
               pd.imageDiv.html(img);
            }
          }
          if(reader.readyState==2) { // set image data as background of div
    ...
    function createProgressDiv(obj, s) {
      ...
      this.imageDiv = $("<div class='ajax-file-upload-image' style='width:60px;height:50px;float:left;'></div>").appendTo(this.statusbar);
