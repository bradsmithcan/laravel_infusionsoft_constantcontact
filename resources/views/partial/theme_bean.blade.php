<div class="bottom_form bottom_form3 bean glink-bg {{$position_theme}}" id="bean"
     style="display: {!! ((isset($snip_data['theme'])&& $snip_data['theme']=='Bean')?'block':'none') !!};">
        ...
        <form action="" method="post">
            <ul>
                <li><span class="profile_left name">
                            ...
                            </span> <span class="profile_right close">
                                @if($user_type==2)
                            <span class="company_name">UserGrow</span> <a href="#">X</a>
                        @endif
                            </span>
                </li>
                <li><span class="profile_left msg" id="profile_left_msg4"
                          style="{!! ((isset($snip_data['text_color']))?'color:#'.$snip_data['text_color']:'') !!};">{!! (isset($snip_data['message'])?$snip_data['message']:'Enter your message') !!} </span>
                            <span id="button-Bean" class="profile_right">
